...
import EC02.clases.desarrollador;
...
public class Pregunta03 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cboTipo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "JAVA", "C#", "PYTHON", "PHP" }));
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        ...
        des.dni = leerDNI();
        des.nombre = leerNombre();
        des.lenguaje = leerLenguaje();
        des.horas = leerHoras();
    ...
    void mostrar(desarrollador des){
        imprimir("Sueldo bruto: "+des.calcularSueldo());
        imprimir("Seguro: "+des.calcularSeguro());
        imprimir("Fondos: "+des.calcularFondos());
        imprimir("Descuento total: "+des.calcularDescuento());
        imprimir("Sueldo neto: "+des.calcularNeto());
    }
