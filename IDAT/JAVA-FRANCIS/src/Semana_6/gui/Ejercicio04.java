...
import Semana_6.clases.Empleado;
...
public class Ejercicio04 extends javax.swing.JFrame {
    ...
    private void btnProcesarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcesarActionPerformed
        ...
        String celular = leerCel();
        double sueldo = leerSueldo();
        
        Empleado emp = new Empleado(codigo,nombre,celular,sueldo);
        mostrar(emp);
        imprimir("");
        emp.setNumero("999888777");
        emp.setSueldo(emp.getSueldo()+200);
        mostrar(emp);
    ...
    void mostrar(Empleado emp){
        imprimir("Código: "+emp.getCodigo());
        imprimir("Nombre: "+emp.getNombre());
        imprimir("Celular: "+emp.getNumero());
        imprimir("Sueldo: "+emp.getSueldo());
        imprimir(emp.validarS());
    }
